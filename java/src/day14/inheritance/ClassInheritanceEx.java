...
public class ClassInheritanceEx {
	...
	public static void main(String[] args) {
		 ...
		 * - 단, 접근제어자가 public, protected인 경우에만 사용가능
		 * - 디폴트는 같은 패키지인 경우는 가능하나, 다른 패키지이면 불가능(편하게하고자사용하는바이지 사용하지않는편이좋음)
		 * 
		 */
		...
		//문법적으로 에러가 발생하지 않으며 예외가 발생 : 다운캐스팅이 안되는 경우이기 때문
		if(p1 instanceof SmartPhone) {
			SmartPhone c1 = (SmartPhone) p1;
			c1.call("123-4567-7891");
		...
		SmartPhone c2 = (SmartPhone)p2;//<< 다운 캐스팅
		c2.call("123-4567");
...
class SmartPhone extends Phone{
	...
	public SmartPhone() {
		...
		//기본 생성자인 super()가 자동으로 추가가되고 호출이된다.
		//이 때 부모 클래스의 기본 생성자가 없으면 에러가 발생
		//supper();에러발생 => 공백을 넣어주면 해결
		super("");
	}
	@Override
	public void call(String num) {
		super.call(num);
		System.out.println("SamrtPhone!");
	}
}
class Camera{
	public void take() {
