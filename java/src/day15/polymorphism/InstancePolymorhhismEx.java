...
public class InstancePolymorhhismEx {
...
//		AirConditioner aricon2 = new AirConditioner();
...
//		
//		
//		HomeAppliances appliances = tv1, aircon1, aircon2;
//		
//		remocon.turnOn(appliances);
//		
////		
//		
//		
...
//		
		...
		for(HomeAppliances homeAppliance : homeAppliances) {
			...
			remocon.turnOff(homeAppliance);// 다운캐스팅이 아님 호출을 부모로했기 때문에
