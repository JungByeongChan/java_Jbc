...
<body>
	<h1>메인</h1>
	<button id="btn1" class="btn btn-outline-success">버튼1</button>
	<button id="btn2" class="btn btn-outline-success mt-2">버튼2</button>
	<button id="btn3" class="btn btn-outline-success mt-3">버튼3</button>
	<button id="btn4" class="btn btn-outline-success mt-4">버튼4</button>
